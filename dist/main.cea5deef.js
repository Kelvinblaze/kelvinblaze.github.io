...
var projects = [{
  name: "Covidng",
  description: "Covidngg is web-based statistic counter or tracker. It helps you stay updated with the latest statistics of all confirmed, deceased, active and recovered cases of corona virus patients in Nigeria.",
  ...
  description: "A simple web based site and PWA that shows important details of all countries of the world.",
  ...
  description: "All of my submissions for the Frontend Mentor Challenges, Includes a list of landing page i have worked on.",
  ...
  name: "AvianQDB",
  description: "AvianQDB is a platform built to help tackle the issue of hiring pilots and aeronautic engineers.",
  ...
  description: "This is a fully functional and responsive Calculator built with VanillaJS in Neumorphism Design",
  ...
  name: "Tiwa Africa",
  description: "Tiwa Africa is a platform that gives African fashion designers the opportunity to showcase their beautiful product, have engagement and also sell them.",
  technologies: ["VUE", "NUXT", "VUETIFY"],
  github: "https://softnexus.co",
  preview: "https://tiwa.africa",
  image: ""
}];
var projectContent = document.querySelector(".all-projects");
var fragment = document.createDocumentFragment();
projects.forEach(function (project) {
  var div = document.createElement("div");
  div.innerHTML = "\n  <div class=\"projects__card\">\n                        <div class=\"projects__card--content\">\n                            <div class=\"projects__card--content--header\">\n                                <h2>".concat(project.name, "</h2>\n                            </div>\n                            <div class=\"projects__card--content--about\">\n                                <p>").concat(project.description, "</p>\n                            </div>\n                            <div class=\"projects__card--content--tech\">\n                                <span>").concat(project.technologies[0], "</span>\n                                <span>").concat(project.technologies[1], "</span>\n                                <span>").concat(project.technologies[2], "</span>\n                            </div>\n                            <div class=\"projects__card--content--links\">\n                                <a href=\"").concat(project.github, "\"><span class=\"fa fa-github\"></span></a>\n                                <a href=\"").concat(project.preview, "\"><span class=\"fa fa-link\"></span></a>\n                            </div>\n                        </div>\n                        <div class=\"projects__card--image\">\n                        </div>\n                    </div>\n  ");
